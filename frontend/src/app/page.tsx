            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-400 max-w-sm">
                  The ultimate Solana fantasy platform where you draft influencer teams and compete for SOL prizes daily.
                </p>
              </div>
...
<div className="space-y-4">
  ...
  <ul className="space-y-2">
    <li>
      <a href="#tournaments" className="text-gray-400 hover:text-purple-400 transition-colors">
        Tournaments
      </a>
    </li>
    <li>
      <a href="#how-to-play" className="text-gray-400 hover:text-purple-400 transition-colors">
        How to Play
      </a>
    </li>
    <li>
      <a href="#leaderboard" className="text-gray-400 hover:text-purple-400 transition-colors">
        Leaderboard
      </a>
    </li>
    <li>
      <a href="#rewards" className="text-gray-400 hover:text-purple-400 transition-colors">
        Rewards
      </a>
    </li>
    <li>
