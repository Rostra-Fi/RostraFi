            ...
            <CardContent className="p-4">
              ...
              <div className="grid grid-cols-5 gap-2 mb-3">
                {[
                  {
                    label: "Teams",
                    value: aggregateStats.teams,
                    icon: <Users className="h-3 w-3" />,
                  },
                  {
                    label: "Posts",
                    value: aggregateStats.posts,
                    icon: <TrendingUp className="h-3 w-3" />,
                  },
                  {
                    label: "Likes",
                    value: aggregateStats.likes,
                    icon: <Heart className="h-3 w-3" />,
                  },
                  {
                    label: "Comments",
                    value: aggregateStats.comments,
                    icon: <MessageSquare className="h-3 w-3" />,
                  },
                  {
                    label: "Views",
                    value: aggregateStats.views,
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge className="text-xs bg-white/10 text-white/80">
                          {post.author.section.charAt(0).toUpperCase() +
                            post.author.section.slice(1)}
                        </Badge>
